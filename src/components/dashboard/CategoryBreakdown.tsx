...
export default function CategoryBreakdown({ items, total }: CategoryBreakdownProps) {
  return (
    <div className="bg-gray-900/70 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6">
      <div className="text-left mb-5">
        <h3 className="text-base font-semibold text-white">Por categoría</h3>
