...
const navItems = [
  { to: '/dashboard', label: 'Dashboard', icon: faChartLine, end: true },
...
export default function Sidebar() {
  return (
    <aside className="w-64 shrink-0 bg-gray-950/80 border-r border-slate-800 flex flex-col">
      <div className="p-6 border-b border-slate-800">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center shadow-lg shadow-orange-500/20">
            <FontAwesomeIcon icon={faGraduationCap} className="text-slate-950 text-lg" />
          </div>
          <div className="text-left">
            <h1 className="text-lg font-bold text-white leading-tight">ASIU</h1>
